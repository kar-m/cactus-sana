...
export class CactusFileSystem {
  ...
  public static writeTempPng(
    pixels: number[],
    width: number,
    height: number
  ): Promise<string> {
    return this.hybridCactusFileSystem.writeTempPng(pixels, width, height);
  }

  public static deleteTempFiles(): Promise<void> {
    return this.hybridCactusFileSystem.deleteTempFiles();
  }
}
